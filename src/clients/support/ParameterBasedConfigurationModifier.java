...
public class ParameterBasedConfigurationModifier extends ConfigurationModifier {
	...
	public void execute(MA_ConfigurationInterface c) {
...
abstract class SettingChanger {
	...
	abstract void execute(MA_ConfigurationInterface c, String value);
...
abstract class ColorChanger extends SettingChanger {
	...
	void execute(MA_ConfigurationInterface c, String value) {
...
class GraphStyleChanger extends SettingChanger {
	static final String key_constant = MA_ConfigurationInterface.Main_graph_style;
	String key() {
		return key_constant;
	}
	void execute(MA_ConfigurationInterface c, String value) {
		String v = value.toLowerCase();
		if (v.equals(MA_ConfigurationInterface.Candle_style) ||
				v.equals(MA_ConfigurationInterface.Regular_style)) {
//System.out.println("Setting " + key() + " to " + value);
...
class BackgroundColorChanger extends ColorChanger {
	static final String key_constant = MA_ConfigurationInterface.Background_color;
...
class LineColorChanger extends ColorChanger {
	static final String key_constant = MA_ConfigurationInterface.Line_color;
	LineColorChanger() {
		key_value = key_constant;
	}
}
...
class BarColorChanger extends ColorChanger {
	static final String key_constant = MA_ConfigurationInterface.Bar_color;
	BarColorChanger() {
		key_value = key_constant;
	}
}
...
class StickColorChanger extends ColorChanger {
	static final String key_constant = MA_ConfigurationInterface.Stick_color;
	StickColorChanger() {
		key_value = key_constant;
	}
}
...
class ReferenceLineColorChanger extends ColorChanger {
	static final String key_constant = MA_ConfigurationInterface.Reference_line_color;
...
class TextColorChanger extends ColorChanger {
	static final String key_constant = MA_ConfigurationInterface.Text_color;
	TextColorChanger() {
		key_value = key_constant;
	}
}
...
class BlackCandleColorChanger extends ColorChanger {
	static final String key_constant = MA_ConfigurationInterface.Black_candle_color;
...
class WhiteCandleColorChanger extends ColorChanger {
	static final String key_constant = MA_ConfigurationInterface.White_candle_color;
