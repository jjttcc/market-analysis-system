...
socket.connect(new InetSocketAddress(hostname, port_number), timeout_value);
...
System.out.println("HERE WE ARE, DUDE!");
...
private void socket_report() {
	...
	System.out.println("socket ReuseAddress: " + socket.getReuseAddress());
