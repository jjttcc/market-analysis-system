...
; This script is for release 1.6.5 of MAS on Windows, the first official
; release of the Windows version.

[Setup]
AppName=Market Analysis System
AppVerName=Market Analysis System 1.6.5
...
Source: "lib\data\tradables\yhoo.txt"; DestDir: "{app}\lib\data"; CopyMode: alwaysoverwrite
Source: "lib\data\tradables\ba.txt"; DestDir: "{app}\lib\data"; CopyMode: alwaysoverwrite
Source: "lib\data\tradables\c.txt"; DestDir: "{app}\lib\data"; CopyMode: alwaysoverwrite
Source: "lib\data\tradables\Cdxnc.csf"; DestDir: "{app}\lib\data"; CopyMode: alwaysoverwrite
Source: "lib\data\tradables\d.txt"; DestDir: "{app}\lib\data"; CopyMode: alwaysoverwrite
Source: "lib\data\tradables\ES01MAR.5-minute"; DestDir: "{app}\lib\data"; CopyMode: alwaysoverwrite
Source: "lib\data\tradables\ES01MAR.txt"; DestDir: "{app}\lib\data"; CopyMode: alwaysoverwrite
Source: "lib\data\tradables\f.txt"; DestDir: "{app}\lib\data"; CopyMode: alwaysoverwrite
Source: "lib\data\tradables\Fcxnc.csf"; DestDir: "{app}\lib\data"; CopyMode: alwaysoverwrite
Source: "lib\data\tradables\Fcxnt.csf"; DestDir: "{app}\lib\data"; CopyMode: alwaysoverwrite
Source: "lib\data\tradables\ibm.5-minute"; DestDir: "{app}\lib\data"; CopyMode: alwaysoverwrite
Source: "lib\data\tradables\ibm.txt"; DestDir: "{app}\lib\data"; CopyMode: alwaysoverwrite
Source: "lib\data\tradables\jp.txt"; DestDir: "{app}\lib\data"; CopyMode: alwaysoverwrite
Source: "lib\data\tradables\nbr.txt"; DestDir: "{app}\lib\data"; CopyMode: alwaysoverwrite
Source: "lib\data\tradables\oakt.txt"; DestDir: "{app}\lib\data"; CopyMode: alwaysoverwrite
Source: "lib\data\tradables\payx.txt"; DestDir: "{app}\lib\data"; CopyMode: alwaysoverwrite
Source: "lib\data\tradables\qcom.txt"; DestDir: "{app}\lib\data"; CopyMode: alwaysoverwrite
Source: "lib\data\symbols.mas"; DestDir: "{app}\lib\data"; CopyMode: alwaysoverwrite
Source: "lib\data\tradables\aa.txt"; DestDir: "{app}\lib\data"; CopyMode: alwaysoverwrite
