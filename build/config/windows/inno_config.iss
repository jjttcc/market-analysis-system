...
; This script is for release 1.6.5a of MAS on Windows, the first bug fix
; release of the first official (1.6.5) release of the Windows version.

[Setup]
AppName=Market Analysis System
AppVerName=Market Analysis System 1.6.5a
...
OutputBaseFilename=setup-mas1.6.5a
