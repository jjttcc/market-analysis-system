...
; This script is for the current release of MAS on Windows.

[Setup]
OutputDir=E:\inno
SourceDir=D:\cygwin\home\jtc\development\inno_source\mas-1.6.6q
AppName=Market Analysis System
AppVerName=Market Analysis System 1.6.6q
...
DefaultDirName=C:\Program Files\mas1.6.6q
UsePreviousAppDir=no
DefaultGroupName=Market Analysis System
OutputBaseFilename=setup-mas1.6.6q
...
Source: "lib\config\parabolic-sar"; DestDir: "{app}\lib\config"; CopyMode: alwaysoverwrite
Source: "lib\config\bollinger_bands"; DestDir: "{app}\lib\config"; CopyMode: alwaysoverwrite
Source: "lib\config\cci"; DestDir: "{app}\lib\config"; CopyMode: alwaysoverwrite
Source: "lib\config\cci_signals"; DestDir: "{app}\lib\config"; CopyMode: alwaysoverwrite
